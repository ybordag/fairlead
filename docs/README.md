...
- [`planning/design.md`](planning/design.md) — design horizon and longer-term
  product shape.
- [`planning/roadmap.md`](planning/roadmap.md) — completed phases, current Halyard
...
- [`current_work/phase_6d_halyard.md`](current_work/phase_6d_halyard.md) — active
  Phase 6D worker execution, retries, and utilization notes.
